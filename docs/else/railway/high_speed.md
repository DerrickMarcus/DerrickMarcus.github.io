...
**CRH380AM-0204**：更高速度试验列车，原 CIT500 型。由南车青岛四方研制，采用6节全动车编组(6M0T)，以 CRH380A 动车组为基础，头车和尾车采用了两种不同头型，外号“**青铜剑**”。2013年3月其在滚动试验台上曾试验时速达605km/h。目前该列车已被改造为高速综合检测列车，并已开始参加检测任务。
