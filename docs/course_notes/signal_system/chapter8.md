...
![2024春信号与系统22第二十讲8.1-8.5_06](../../assets/images/course_notes/signal_system/ch8_img1.png)

也可以由洛朗级数引出（~~又到了最喜欢的复变~~）。

![2024春信号与系统22第二十讲8.1-8.5_07](../../assets/images/course_notes/signal_system/ch8_img2.png)
