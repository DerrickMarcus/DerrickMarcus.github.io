...
半导体：最外层满带，更高能带全空，绝对零度下不导电。但是禁带宽度较小，一般小于 2eV，室温下最高的满带电子可以热激发到上面的空带，两个能带都变成部分填充带。最外层能带称为导带，次外层能带称为价带。拓展：宽禁带半导体。
...
$$
\sigma_0=\frac{ne^2\tau(E_F)}{m^*}=ne\frac{\tau(E_F)}{m^*}=ne\mu
$$
...
$$
1-f(E)=\frac{\mathrm{e}^{(E-E_F)/k_BT}}{e^{(E-E_F)/k_BT}+1} \approx \mathrm{e}^{-(E_F-E)/k_BT} \ll 1
$$
...
回顾第三章，能量标度下的态密度 $\dfrac{V}{2\pi^2}(\dfrac{2m}{\hbar^2})^{3/2}\sqrt{E}$ ，三维情形下电子能量越高，能态密度越大。
...
可以在远离导带底形成施主能级，或原理价带顶形成受主能级。深能级杂质往往形成多重杂质能级，如 $\ce{Au}$ 在硅中，形成了靠近价带的施主能级，也形成了靠近导带的受主能级。深能级杂质作为复合中心，可以有效降低载流子寿命，提高材料电阻率。
...
<span style="font-size:24px">以 N 型半导体（施主浓度大于受主浓度）为例：</span>
...
<span style="font-size:24px">以 P 型半导体（受主浓度大于施主浓度）为例：</span>
...
对于 N 型半导体（实线），由于杂质能级束缚能很小，在很低温度下束缚能级上的电子就被热激发到导带（施主激发），载流子 $n$ 浓度随温度升高而增加。当施主能级所有电子都被热激发到导带上，且还没有达到价带电子的热激发温度时，载流子 $n$ 浓度基本等于施主杂质浓度，不随温度变化，出现“平台期”。当温度上升到足够高使得价带电子热激发到导带上，载流子 $n$ 浓度再次随着温度升高而增大，且逐渐趋向于本征载流子 $n_i$ 浓度。图中也可以看出，由于 $\ce{Ge}$ 的禁带宽度比 $\ce{Si}$ 小，因此发生本征激发和施主激发的温度更低。

![202506101641888](https://cdn.jsdelivr.net/gh/DerrickMarcus/picgo-image/images/202506101641888.png)

上图中可以看出，掺杂浓度越高，费米能级越靠近导带或价带，越远离本征费米能级。且随着温度升高，费米能级逐渐向本征费米能级靠近，这是因为载流子浓度增加缓慢（受掺杂限制），而本征载流子浓度 $n_i$ 指数级增长，本征激发逐渐超过杂质激发，载流子浓度越来越接近于本征载流子浓度，因此费米能级逐渐向本征费米能级靠近。
...
若费米能级高于本征费米能级，更靠近导带，显示出 N 型的性质，则 $n>n_i>p$ 。反之同理。
...
金属：载流子为电子，浓度变化很小。电导率 $\sigma_0=\dfrac{ne^2\tau(E_F)}{m^*}=ne\dfrac{\tau(E_F)}{m^*}=ne\mu$ ，主要决定于费米能级附近电子弛豫时间。温度升高时，电子浓度 $n$ 不变，迁移率 $\mu$ 下降，电导率 $\sigma$ 下降。
