...
半对。金属的费米能级在导带中，半导体的费米能级**一般**在禁带中，但是简并半导体能级进入能带中。
...
(3) 判断：P型半导体的迁移率随着掺杂浓度升高而降低，但电导率却随着掺杂浓度升高而增加。
...
正确。格波波矢加上若干个 $\frac{2pi}{a}$ 之后，虽然波长不同，但是对应位置的原子不变，描述的使用一个格波。注意与晶格中倒格矢波矢、简约波矢的区别。
