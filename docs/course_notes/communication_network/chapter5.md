...
2. 全纠错。在 bit 码空间中，距离 $00\cdots 0$ 较近的判为全 0，距离 $11\cdots 1$ 较近的判为全 1 。若 $d$ 为奇数，则 $2t+1=d$ ，若 $d$ 为偶数，则 $2t+2=d$ ，综合起来就是 $t=\left\lfloor\dfrac{d-1}{2}\right\rfloor,\;e=t$ ，即检出错误都能纠正。
3. 既检错又纠错。在 bit 码空间中，在两个半径为 $t$ 的圆之外，均为无法纠错的野生 bit 串，圆之内的能够纠错，因此 $t+e+1=d$ .
